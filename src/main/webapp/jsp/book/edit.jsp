	...
	<input type="hidden" id="basepath" value="<%=basePath%>">
		<div class="panel admin-panel">
			...
			<div class="body-content">
				<form method="post" class="form-x" action="book/edit.do">
					<div class="form-group">
						...
						<div class="field">
							...
							<input type="text" class="input w50" value="${book.name}" name="name"
								data-validate="required:请输入图书名称" />
						   <input type="hidden" id="picture" name="picture" value="${book.picture}">
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
          ...
          <div class="field">
            <select name="bookType.id" id="bookType.id" class="input w50">
              ...
              <c:forEach items="${list}" var="bookType">
                  <c:choose>
                    <c:when test="${bookType.id==book.bookType.id}">
                    <option value="${bookType.id}" selected="selected">${bookType.name}</option>
                    </c:when>
                    <c:otherwise>
            ...
            <div class="tips"></div>
					...
					<div class="form-group">
						...
						<div class="field">
							<div id="imgshow">
								<img  src="<%=imgPath%>${book.picture}" id="img" width="80px" height="120px">
							</div>
					...
					<div class="form-group">
						...
						<div class="field">
							<textarea class="input" name="detail" style="height: 90px;">${book.detail}</textarea>
							<div class="tips"></div>
						</div>
					</div>
